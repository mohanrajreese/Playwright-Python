...
class LendingKart(PortalFetch):

    def login(Self):
        conf = ["9993070611","9617449210","9250875036"] 
        ...
        with sync_playwright() as playwright:
            ...
            for number in range (len(conf)):
                ...
                print(conf[number], Status.all_inner_texts(), Sub_Status.all_inner_texts())
